...
?>
	<body>
		...
		<section id="main" class="wrapper">
			<div class="container"> 
				<div class="12u$">
					<button data-toggle="collapse" data-target="#enter"><i class="fas fa-sign-in-alt"> Enter new Grade</i></button>
						...
						<div class="inner"> 
							...
							<form method="post" action="grade.php">
								<div class="row uniform">
									...
									<div class="12u$">
										<b>Grade<sup>*</sup></b>
										<input type="text" maxlength="2" name="grade" id="grade" placeholder="1" />
									</div>
									<!-- Break -->
									<div class="row uniform">
										<b>Active</b>
